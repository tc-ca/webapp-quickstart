...
CREATE PROCEDURE SP_TODO_CREATE (@name NVARCHAR(255), @priority INT)
AS
	INSERT INTO [FC001_TODO] (NAME_NM, PRIORITY_AMT)
	VALUES (@name, @priority)
GO

CREATE PROCEDURE SP_TODO_DELETE (@id INT) 
AS
	DELETE FROM [FC001_TODO]
	WHERE [TODO_ID] = @id
GO

CREATE PROCEDURE SP_TODO_UPDATE (@id INT, @name NVARCHAR(255), @priority INT) 
AS
	UPDATE [FC001_TODO]
	SET NAME_NM = @name,
